...
namespace Hdc.Controls.Charts
{
    public sealed class Arrow : Shape
    {
        ...
        public static readonly DependencyProperty ShowLeftProperty = DependencyProperty.Register("ShowLeft", typeof(bool), typeof(Arrow), new FrameworkPropertyMetadata(true));
        public static readonly DependencyProperty ShowRightProperty = DependencyProperty.Register("ShowRight", typeof(bool), typeof(Arrow), new FrameworkPropertyMetadata(true));
        #endregion
